...
class AdminController extends Controller
{
    ...
    {
        if (is_null($this->user) || !$this->user->can('subadmin.view')) {
    ...
    {
        if (is_null($this->user) || !$this->user->can('subadmin.create')) {
    ...
    {
        if (is_null($this->user) || !$this->user->can('subadmin.edit')) {
    ...
    {
        if (is_null($this->user) || !$this->user->can('subadmin.delete')) {
